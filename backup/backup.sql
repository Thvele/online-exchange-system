...
INSERT INTO `buy_list` VALUES (1,9,1,'Получен','2022-12-02 18:18:03'),(2,8,5,'Возврат','2022-12-02 18:18:03');
...
INSERT INTO `requestmrg` VALUES (1,'123',8,_binary '');
...
INSERT INTO `requestts` VALUES (2,'1231231231231','собака',2,8,'Закрыто');
...
INSERT INTO `user` VALUES (6,_binary '',98.90,'thvele@mail.ru','thvele1','$2a$08$n2AOMAF.MwpI.narUb6xk.garXZFpoJVbJchq9f6SvuTljrfRTxrW','/usericons/def.jpg'),(7,_binary '',979154.00,'oadsfo@aodsnfo.s','0ooasdmna','$2a$08$1JlAxxej/3UfXbkClO.EIey0qZeNybFWS1.2PrqWzGcjlvzuirBe6','https://i.pinimg.com/564x/0a/13/f8/0a13f80b997386f2bae191cfa619c20d.jpg'),(8,_binary '',11280.96,'kolokol1@maiil.ru','uuu123','$2a$08$cp32IxHGQlkmtOMlU2gceeUrT4t5R4zaU.jg0tijg/uPSfqQc0p56','/usericons/uuu123aCQv1Oz6tGI.jpg'),(9,_binary '',-11280.96,'','123131adsfasdgsadg','$2a$08$T0Gnz8PGAedZkwh33sLS6uMzfyGroXwyQqcy5wZ9Gb6UdrTa25uMG','/usericons/def.jpg'),(10,_binary '',0.00,'uuu@mail.ru','uuu1234','$2a$08$xGKrxbjGPLlwAC/ItbxTl.ZBWGQFFw0cwyuS1YvAj0mHiJPw5Q3cy','/usericons/uuu1234uuu12376460ef72e97803b48f54035fe429eac.gif');
...
INSERT INTO `user_roles` VALUES (9,'USER'),(8,'USER'),(8,'SELLER'),(8,'ADMIN'),(8,'MODERATOR'),(10,'USER');
...
-- Dump completed on 2022-12-10 19:08:00
